...
public class LucidDBStreamingLoaderMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public static String OPERATION_INSERT = "UPSERT";
  ...
  public String getDMLStatement( VariableSpace space, RowMetaInterface prev ) throws KettleStepException {
    ...
    if ( operation.equals( OPERATION_INSERT ) ) {
      ...
      insert.append( "UPSERT INTO " + Const.CR );
      ...
      if ( isDebug() ) {
        logDebug( "-----UPSERT----" + insert + "-----END INSERT-----" );
      }
    ...
    if ( operation.equals( OPERATION_MERGE ) || operation.equals( OPERATION_UPDATE ) ) {
      ...
      if ( operation.equals( OPERATION_MERGE ) ) {
        ...
        merge.append( "UPSERT " + buildTargetColumnsForInsert() + Const.CR );
